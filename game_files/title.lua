...
function Title:new()
  ...
  -- FONT
  self.descFont = love.graphics.newFont("assets/font.ttf", 12)
  self.optionsFont = love.graphics.newFont("assets/font.ttf", 30)
  self.titleFont = love.graphics.newFont("assets/font.ttf", 50)
      ...
      if key == "space" or key == "enter" then
        ...
        elseif self.options == 2 then
          ...
          elseif self.options2[self.selected] == "CONTROLS" then
            self.options = 3
            self.selected = 1
          elseif self.options2[self.selected] == "LEVEL " .. level .. "/" .. NUM_LEVELS then
            level = level + 1
            if level == NUM_LEVELS + 1 then
              level = 1
            end
