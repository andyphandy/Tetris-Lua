...
-- NOTE: Difference between MAP_LENGTH and MAP_PLAY_LENGTH must be greater than 3
MAP_WIDTH = 10
MAP_LENGTH = 26
MAP_PLAY_LENGTH = 20
...
function love.load()
  ...
  clearFont = love.graphics.newFont("font.ttf", 24)
...
function love.update(dt)
  ...
  elseif gameState == "play" then
    ...
    if numCleared >= level * LVL_INTERVAL then
      level = level + 1
      map:levelUp()
    end
  end
...
function drawInfo()
  ...
  love.graphics.printf(level .. "/25", LENGTH, LENGTH * 12, LENGTH * 3, "center")
